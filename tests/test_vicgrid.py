...
known_vals_agd66 = [
    ...
    (dms_to_dd(-34, 29, 46.7724), dms_to_dd(141, 59, 14.8833), 2223143.321, 4773459.258),
    (dms_to_dd(-38, 3, 59.0913), dms_to_dd(141, 24, 52.3647), 2185431.606, 4375727.525),
    (dms_to_dd(-37, 23, 45.2184), dms_to_dd(148, 46, 38.6881), 2834353.246, 4449435.092),
...
def test_known_vals_easting(lat, lng, E, N):
    ...
    e, n, m, y = geographic_to_vicgrid(lat, lng, datum=AGD66)
    diff = abs(e-E)
    assert diff <= TOL

...
class GeoMag:
    def __init__(self):
        ...
        wmm = []
        with open(filename) as wmm_file:
    ...
    def compute(self, dlat, dlon, time=date.today()):
        """
        ...
        if glat != olat:
            ...
            q2 = (self.a2 / self.b2) * (self.a2 / self.b2)
            ct = srlat / math.sqrt(q2 * crlat2 + srlat2)
            st = math.sqrt(1.0 - (ct * ct))
            r2 = (self.a4 - self.c4 * srlat2) / (q * q)
            r = math.sqrt(r2)
